...
print("Mean (numpy):", np_mean, "| Mean (custom):", custom_mean)
print("Variance (numpy):", np_var, "| Variance (custom):", custom_var)
print("Avg time (numpy):", avg_np_time, "| Avg time (custom):", avg_custom_time)
